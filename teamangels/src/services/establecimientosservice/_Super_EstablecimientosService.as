...
internal class _Super_EstablecimientosService extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{
    ...
    public function _Super_EstablecimientosService()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "getAllEstablecimientosByDocumento_Empresa");
         operation.resultType = Object;
        operations["getAllEstablecimientosByDocumento_Empresa"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "getAllEstablecimientosByDocumento");
         operation.resultType = Object;
        operations["getAllEstablecimientosByDocumento"] = operation;
    ...
    /**
      * This method is a generated wrapper used to call the 'getAllEstablecimientosByDocumento_Empresa' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function getAllEstablecimientosByDocumento_Empresa(documento:String) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("getAllEstablecimientosByDocumento_Empresa");
		var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(documento) ;
        return _internal_token;
    }
     
    /**
      * This method is a generated wrapper used to call the 'getAllEstablecimientosByDocumento' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function getAllEstablecimientosByDocumento(documento:String) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("getAllEstablecimientosByDocumento");
		var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(documento) ;
        return _internal_token;
    }
